...
using Watcher.Backend.Domain.Json.Movies;
using Watcher.Backend.Domain.Json.Persons;
using Watcher.Backend.Domain.Json.Shows;
using Watcher.Messages.Movie;
using Watcher.Messages.Person;
using Watcher.Messages.Show;

namespace Watcher.Backend.Domain.Json
{
